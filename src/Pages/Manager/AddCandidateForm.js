...
const AddCandidateForm = () => {
  ...
  const handleAddCandidate = async () => {
    try {
      ...
      setError(
        "An error occurred while adding the candidate.Please check the email  phone number"
      );
  ...
  return (
    ...
    >
      <Container
        style={{ backgroundColor: "white", width: "70%", paddingTop: "50px" }}
      >
        <Typography
          sx={{
            paddingBottom: "5%",
        ...
        <FormControl
          ...
          variant="outlined"
          className="custom-select"
          style={{ width: "360px", paddingBottom: "6px" }}
        >
        ...
        <Select
          ...
          variant="outlined"
          className="custom-select"
          style={{ paddingBottom: "5px", fontFamily: `'Calibri', sans-serif` }}
