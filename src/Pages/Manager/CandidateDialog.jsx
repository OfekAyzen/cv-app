...
const CandidateDialog = ({
  ...
  //   // Check if cvFileKey exists
  //   console.log("selectedCandidate.cv " ,selectedCandidate.cv, "selectedCandidate : ",selectedCandidate);
  //   if (selectedCandidate && selectedCandidate.cv) {
  //     // Construct the download URL using the cvFileKey
  //     const downloadUrl = Storage.get(selectedCandidate.cv);

  //     // Open a new tab to initiate the download
  ...
  //     // Construct the download URL using the cvFileKey
  //     const downloadUrl = Storage.get(selectedCandidate.cv);
  //     console.log("download url : ",selectedCandidate.cv);
  ...
  //   if (selectedCandidate && selectedCandidate.cv) {
  //     // Construct the download URL using the cvFileKey
  //     const downloadUrl = Storage.get(`public/${selectedCandidate.cv}`);
  //     console.log("selectedCandidate.cv   :",selectedCandidate.cv);
  //     // Create a hidden anchor element
  //     const link = document.createElement('a');
  //     link.href = downloadUrl;
  //     link.target = '_blank';
