    ...
    const fetchJobDetails = async () => {
      ...
      try {
        const response = await API.graphql(
          graphqlOperation(getJobs, { id: jobIdToFetch })
        );
  ...
  return (
    ...
    >
      {loading ? (
        <div
          style={{
            height: isMobileView ? "900px" : "1200px",
        ...
        <div
          style={{
            width: isMobileView ? "420px" : "100%",
            paddingTop: isMobileView ? "2%" : "2%",
          }}
        >
          <Button
            onClick={onClose}
          ...
          {jobDetails && (
            ...
            >
              ...
              >
                ...
                <Typography className="position-text" variant="body1">
                ...
                <JobApplication
                  job_id={(selectedJob && selectedJob.id) || jobID}
