...
export default function ProfileUser(props) {
  ...
  const Jobs = {
    ...
    qualifications: "slkdfh dsfkjsdfkj saflsdjkf",
  };
          ...
          >
            <Typography
              ...
              sx={{
                ...
                textAlign: "center",
                marginBottom: isMobileView ? "20px" : "10px",
                fontSize: isMobileView ? "28px" : "50px",
                fontWeight: "bold",
              }}
            >
            ...
            <Typography
              ...
              sx={{
                ...
                fontWeight: "bold",
                marginBottom: isMobileView ? "30px" : "10px",
              }}
            >
              Solutions
            </Typography>
        ...
        <Grid item xs={6} sm={6} sx={{ textAlign: "right" }}>
          <Box sx={{ padding: "0px", height: "300px" }}>
            <img
              ...
              style={{
                maxWidth: "100%",
                height: isMobileView ? "250px" : "400px",
                paddingBottom: isMobileView ? "30px" : "0px",
              }}
            />
          </Box>
        </Grid>
